...
public class SettingsFile
{
    ...
    throws CATReporterException
  {
    ...
    {
      throw new CATReporterException("Unable To Create Required Files for Custom Reports");
    }
  }
    ...
    throws CATReporterException
  {
    ...
    {
      throw new CATReporterException("Settings File Not Available");
    }
    catch (IOException localIOException)
    {
      throw new CATReporterException("Unable To Create Required Files for Custom Reports");
  ...
  public static void correctErrors()
    throws NumberFormatException, CATReporterException
  {
