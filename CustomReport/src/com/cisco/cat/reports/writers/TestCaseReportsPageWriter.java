...
import com.cisco.cat.reports.enums.Colors;
import com.cisco.cat.reports.enums.ExceptionDetails;
  ...
  extends ReportsPage
{
  ...
  public static void content(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
  {
    ...
    AuthorDetails localAuthorDetails2 = null;
    try
    {
      if (paramITestResult.getAttribute("authorInfo") == null)
      {
        if (localAuthorDetails1 == null) {
          localAuthorDetails2 = new AuthorDetails();
        } else {
          localAuthorDetails2 = localAuthorDetails1;
        }
      }
      else {
        localAuthorDetails2 = (AuthorDetails)paramITestResult.getAttribute("authorInfo");
      }
    }
    catch (Exception localException1) {}
    paramPrintWriter.println(" <div class=\"chartStyle summary\" style=\"background-color: #7F525D;margin-left: 20px; height: 200px;width: 30%; \">\n                       <b>Author Info</b><br/><br/>\n                        <table>\n                            <tr>\n                                <td>Author Name</td>\n                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n                                <td>" + localAuthorDetails2.getAuthorName() + "</td>                                \n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Creation Date</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + localAuthorDetails2.getCreationDate() + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>Version</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + localAuthorDetails2.getVersion() + "</td>\n" + "                            </tr>\n" + "                            <tr>\n" + "                                <td>System User</td>\n" + "                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>\n" + "                                <td>" + Platform.USER + "</td>\n" + "                            </tr>\n" + "                        </table> \n" + "                    </div>\n" + "                    ");
    Object localObject1;
    int i;
    Object localObject2;
    if ((paramITestResult.getStatus() != 3) || ((paramITestResult.getStatus() == 3) && ((paramITestResult.getThrowable() instanceof SkipException))))
    {
    ...
    if ((paramITestResult.getParameters().length > 0) || (paramITestResult.getStatus() == 3) || (paramITestResult.getStatus() == 2))
    {
      ...
      if (paramITestResult.getParameters().length > 0)
      {
        ...
        for (Object localObject22 : paramITestResult.getParameters()) {
          paramPrintWriter.print("Param: " + localObject22.toString() + "<br/>");
        }
      }
      if (paramITestResult.getStatus() == 3)
      {
        ...
        String str1;
        //String str2;
        if (localObject1.toString().length() > 0)
        {
          str1 = "";
          for (String str2 : (String[])localObject1) {
            str1 = str1 + str2 + "<br/>";
          }
        ...
        try
        {
          if ((paramITestResult.getThrowable() instanceof SkipException)) {
            paramPrintWriter.print("TestNG Skip Exception: " + paramITestResult.getThrowable().getMessage() + "<br/><br/>");
          }
        }
  ...
  {
    //switch (1.$SwitchMap$atu$testng$reports$logging$LogAs[paramLogAs.ordinal()])
  ...
  public static void menuLink(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
  {
    ...
    paramPrintWriter.println(" <li style=\"padding-top: 4px;\"><a href=\"" + getTestCaseHTMLPath(paramITestResult) + "ConsolidatedPage.html\" >Consolidated Page</a></li>\n");
    if (paramInt == 1) {
